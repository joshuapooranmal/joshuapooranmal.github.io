...
Our model identifies nstrumentalness, danceability, and speechiness as the most important variables when determining a hit. This makes sense. Many songs nowadays are low in instrumentalness and high in speechiness. Furthermore, (pre-pandemic) contemporary society is big on clubs and social gatherings, so danceability is very important. 

## Future Implication and Stretch Goals
